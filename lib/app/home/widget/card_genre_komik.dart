...
import 'package:komikoproject/app/module/jenis_page/view/genre_page.dart';
import 'package:komikoproject/core/controller/controller.dart';
import 'package:vs_scrollbar/vs_scrollbar.dart';
import '../../../core/theme/color.dart';

class CardGenreKomik extends SliverPersistentHeaderDelegate {
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          ...
                          Get.to(() => GenrePage(keys: '${data[index]}'));
                        },
                        child: Padding(
